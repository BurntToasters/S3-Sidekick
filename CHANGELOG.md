...
| :--- | :--- | :--- |
| **EXE: [x64](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-Windows-x64.exe) / [arm64](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-Windows-arm64.exe)** | **[Universal DMG](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-macOS.dmg)** | **AppImage:** [x64](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-Linux-x64.AppImage) <!--/  [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-arm64.AppImage) --> |
| <!-- <div align="center"><a href="https://apps.microsoft.com/detail/9pkgd6lkcl5j?referrer=appbadge&mode=full"><img src="https://get.microsoft.com/images/en-us%20light.svg" width="150"/></a></div>--> | **[Universal ZIP](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-macOS.zip)** | **DEB:** [x64](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-Linux-x64.deb) <!--/ [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-arm64.deb)--> |
| <!--*See MSI note below*--> | | **RPM:** [x64](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-Linux-x64.rpm) <!--/ [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-aarch64.rpm)--> |
| | | **Flatpak:** [x64](https://github.com/BurntToasters/S3-Sidekick/releases/download/v0.9.4-beta.9/S3-Sidekick-Linux-x64.flatpak) <!--/ [arm64](https://github.com/BurntToasters/IYERIS/releases/download/v1.0.4/IYERIS-Linux-aarch64.flatpak)--> |

### ℹ️ Enjoying S3 Sidekick? Consider [❤️ Supporting Me! ❤️](https://rosie.run/support)

## Changes  in `v0.9.4-beta.9:`
* **Win:** Testing a new fix for windows hello not working.
  * Added `setFocus` to force window focus to prevent windows hello from being interrupted.

## Changes  in `v0.9.4-beta.8:`
* **Win:** Testing a new fix for windows hello not working.

## Changes  in `v0.9.4-beta.7:`
* **Win:** Testing a new fix for windows hello not working.

## Changes  in `v0.9.4-beta.6:`
* **Win:** Testing a fix for windows hello not working.

## Changes  in `v0.9.4-beta.5:`
* **macOS:** Addressed an issue with biometric unlock.

## Changes  in `v0.9.4-beta.4:`
* **macOS:** Addressed an issue with the biometrics updater and unlocker that would cause biometric unlock to fail.
